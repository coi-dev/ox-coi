...
class CustomerConfig {
  ...
  CustomerConfig({this.name, this.chats, this.icons});

  CustomerConfig.fromJson(Map<String, dynamic> json) {
    name = json[_jsonName];
    icons = List.from(json[_jsonIcons]);

    json[_jsonChats]?.forEach((chat) {
      chats.add(CustomerChat.fromJson(chat));
    });
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    json[_jsonName] = name;
    json[_jsonChats] = chats.map((chat) => chat.toJson()).toList();
    json[_jsonIcons] = icons;
