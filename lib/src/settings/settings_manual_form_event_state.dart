...
abstract class SettingsManualFormEvent {}

class SetupSettings extends SettingsManualFormEvent {
...
abstract class SettingsManualFormState {}

class SettingsManualFormStateInitial extends SettingsManualFormState {}

class SettingsManualFormStateReady extends SettingsManualFormState {
  final String email;
  final String password;
  final String imapLogin;
  final String imapServer;
...
class SettingsManualFormStateValidation extends SettingsManualFormState {}

class SettingsManualFormStateValidationSuccess extends SettingsManualFormState {
  final String email;
  final String password;
  final String imapLogin;
  final String imapServer;
...
class SettingsManualFormStateValidationFailure extends SettingsManualFormState {}
